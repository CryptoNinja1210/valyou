...
export const MessageDetails = ({ tapMessage }) => {
  return (
    <div className="md:w-[80%] px-5">
      <div className="flex-1 sm:p-2 justify-between flex flex-col h-[58vh]">
        <div className="flex sm:items-center justify-between py-0 border-b-2 border-gray-200">
          <div className="relative flex items-center space-x-4">
            <IconButton className="md:!hidden" onClick={tapMessage}>
        ...
        >
          ...
          <div className="chat-message">
            <div className="flex items-end justify-end">
              <div className="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-1 items-end">
                <div>
                  <span className="px-4 py-2 rounded-lg inline-block bg-pink-600 text-white ">
                    Are you using sudo?
                  </span>
                </div>
                <div>
      ...
      <div className="border-t-2 border-gray-200 px-0 pt-4 mb-2 sm:mb-0">
        <div className="absolute bottom-0 z-10 w-full flex">
          <Input
            type="text"
            placeholder="Write your message!"
            className="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-1 bg-gray-200 rounded-md py-3"
          />
